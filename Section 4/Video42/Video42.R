...
#Export these data in Shapefile
shapefile(x=Earthquake.MidDay, 
          filename="Earthquake_MidDay.shp")

#You may see a warning message once you run the line above.
#This is due because the ESRI standard does not allow for long 
#columns names, so R needs to abbreviate some.
